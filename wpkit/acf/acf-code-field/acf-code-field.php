...
load_plugin_textdomain( 'acf-code-field', false, get_template_directory() . '/wpkit/acf/acf-code-field/lang/' );

define( 'ACFCF_CODEMIRROR_VERSION', 'codemirror-5.23.0' );
define( 'ACFCF_PLUGIN_DIR', get_template_directory() . '/wpkit/acf/acf-code-field/' );
